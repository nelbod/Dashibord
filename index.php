...
<body>
    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <div class="text-2">Lionel Bodé</div>
                <div class="text-3">Je suis un<span class="typing"></span></div>
                <a href="#">Suivez moi.</a>
            </div>
        </div>
    </section>
        ...
        <div class="max-width">
            ...
            <div class="about-content">
                ...
                <div class="column right">
                    <div class="text">Je m'appelle Lionel, je suis un <span class="typing-2"></span></div>
                    <p></p>
    ...
    <section class="skills" id="skills">
        <div class="max-width">
            ...
            <div class="skills-content">
                <div class="column left">
                    <div class="text">Mes compétences créatives & experiences.</div>
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Lionel Bodé</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Cotonou;Agla</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">bodelionl1@gmail.com</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer>
        <span>Creer par <a href="#">Lionel Bodé</a> | <span class="far fa-copyright"></span> 2022 All rights reserved.</span>
    </footer>
